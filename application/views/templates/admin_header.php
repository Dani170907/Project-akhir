	...
	<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
      ...
      <img src="<?= base_url('assets/images/SA.png') ?>" alt="Logo" class="h-12">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
			...
			<li><a class="text-sm <?= ($currentPage == 'admin/event') ? 'text-blue-600 font-bold' : 'text-gray-400' ?> hover:text-gray-500" href="<?= base_url('admin/event') ?>">Data Event</a></li>
			</li>
		</ul>
          ...
          <img src="<?= base_url('assets/images/SA.png') ?>" alt="Logo" class="h-12">
			...
			<div>
				<ul>
					...
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="<?= base_url('admin/event') ?>">Data Event</a>
					</li>
				</ul>
			</div>
			<div class="mt-auto">
				<div class="pt-6">
					<a class="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 rounded-xl" href="<?= base_url() ?>Login/logout">Log Out</a>
				</div>
			</div>
		</nav>
	</div>
