<div class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="relative z-10 bg-white p-8 rounded-md shadow-lg w-full max-w-sm lg:max-w-lg">
        ...
        <?php if (!empty($tb_pendaftaran)): ?>
            <form action="<?= base_url('Edit/updatePendaftaran/' . $tb_pendaftaran['idPendaftaran']); ?>" method="post" onsubmit="return handleSubmit()">
                <div class="mb-4">
...
<script>
    ...
    function handleSubmit() {
        const selectedLomba = document.getElementById('lomba').value;

        if (!selectedLomba) {
            showAlert('Gagal!', 'Pilih Lomba tidak boleh kosong!', 'error', null);
            return false; 
        }
